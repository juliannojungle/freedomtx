...
static void detectChargingMode(void)
{
  ...
  while (IS_CHARGING_STATE() && usbPlugged() && !pwrPressed()) {
...
void boardInit()
{
  RCC_AHB1PeriphClockCmd(PWR_RCC_AHB1Periph |
                         ...
                         ADC_RCC_AHB1Periph | SD_RCC_AHB1Periph | HAPTIC_RCC_AHB1Periph |
                         EXTMODULE_RCC_AHB1Periph | TELEMETRY_RCC_AHB1Periph |
  ...
  RCC_APB1PeriphClockCmd(LCD_RCC_APB1Periph | AUDIO_RCC_APB1Periph | ADC_RCC_APB1Periph |
                         ...
                         TIMER_2MHz_RCC_APB1Periph | SD_RCC_APB1Periph   | TELEMETRY_RCC_APB1Periph |
                         AUX_SERIAL_RCC_APB1Periph , ENABLE);

  RCC_APB2PeriphClockCmd(BACKLIGHT_RCC_APB2Periph | ADC_RCC_APB2Periph  |
                         HAPTIC_RCC_APB2Periph | EXTMODULE_RCC_APB2Periph | ROTARY_ENCODER_RCC_APB2Periph |
                         HEARTBEAT_RCC_APB2Periph, ENABLE);
