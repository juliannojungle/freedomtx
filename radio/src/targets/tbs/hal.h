...
// Telemetry
  ...
  #define TELEMETRY_RX_POLARITY_RX_PIN    GPIO_Pin_7  // PC.07
  #define TELEMETRY_RX_POLARITY_INVERT()  TELEMETRY_RX_POLARITY_GPIO->BSRRL = TELEMETRY_RX_POLARITY_RX_PIN
  #define TELEMETRY_RX_POLARITY_NORMAL()  TELEMETRY_RX_POLARITY_GPIO->BSRRH = TELEMETRY_RX_POLARITY_RX_PIN
  ...
  #define TELEMETRY_RX_POLARITY_RX_PIN    GPIO_Pin_11 //PB.11
  #define TELEMETRY_RX_POLARITY_INVERT()  TELEMETRY_RX_POLARITY_GPIO->BSRRL = TELEMETRY_RX_POLARITY_RX_PIN
  #define TELEMETRY_RX_POLARITY_NORMAL()  TELEMETRY_RX_POLARITY_GPIO->BSRRH = TELEMETRY_RX_POLARITY_RX_PIN
