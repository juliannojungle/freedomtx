...
#define _HAL_H_
  ...
  #define ROTARY_ENCODER_RCC_APB1Periph   RCC_APB2Periph_TIM11
  #define ROTARY_ENCODER_TIMER            TIM11
  #define ROTARY_ENCODER_TIMER_IRQn       TIM1_TRG_COM_TIM11_IRQn
  #define ROTARY_ENCODER_TIMER_IRQHandler TIM1_TRG_COM_TIM11_IRQHandler
#else
  ...
  // 1ms Interrupt
  #define INTERRUPT_1MS_RCC_APB2Periph    RCC_APB2Periph_TIM11
